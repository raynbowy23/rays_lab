...
def main():
    ...
    # Save and Load
    parser.add_argument('--sample_frequency', '-sf', type=int, default=5000,
    ...
    # init weights
    # TODO: for loop of model.parameters()
    ...
    for epoch in tqdm(range(total_epoch)):
        ...
        for i, data in enumerate(train_loader):
            ...
            fake_A, fake_B = G_B2A(real_B), G_A2B(real_A) # Create fake images
            rec_A, rec_B = G_B2A(fake_B), G_A2B(fake_A) # Recreate fake images
            ...
            # get simple
            if (epoch * len(train_loader) + i) % args.sample_frequency == 0:
                ...
                save_image(images_sample, "sample/" + args.model + "/" + str(epoch * len(train_loader) + i) + ".png", row=3, normalize=True)
